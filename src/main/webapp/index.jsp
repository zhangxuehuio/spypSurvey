    ...
    <section id="banner">
        <div class="inner">
            ...
            <div class="row uniform">
                <p class="3u"></p>
                <p class="6u text-left">　　根据2013年3月10日披露的国务院机构改革和职能转变方案，食品药品监督管理部门要转变管理理念，创新管理方式，充分发挥市场机制、行业自律和社会监督作用，建立让生产经营者真正成为食品药品安全第一责任人的有效机制，充实加强基层监管力量，切实落监管责任，不断提高食品药品安全质量水平。根据《中华人民共和国统计法》、《中华人民共和国食品安全法》、《中华人民共和国药品管理法》等有关法律法规，结合目前统计状态和实际困难，特别是在大数据时代的监管统计需求，现有统计指标和统计报表制度需要进行梳理完善，使其充分发挥统计在食品药品监督管理工作中的重要作用。
                </p>
            </div>
